...
public class ForumDAO {
	...
	public String getTargetURLParam(String pageUrl, HashMap<String, Object> hm, String index) throws Exception{
		...
		if (hm != null) {
			...
			if(!"".equals(Function.checkNull(Function.parseStr(hm.get("syear"))))){
				strList.append("&syear="+Function.parseStr(hm.get("syear")));
			}
			if(!"".equals(Function.checkNull(Function.parseStr(hm.get("smonth"))))){
				strList.append("&smonth="+Function.parseStr(hm.get("smonth")));
			}
			if(!"".equals(Function.checkNull(Function.parseStr(hm.get("snowdate"))))){
				strList.append("&snowdate="+Function.parseStr(hm.get("snowdate")));
			}
			if (!"0".equals(index)) {
	...
	public int[] count(HashMap<String, Object> vo) throws SQLException {
		int rowCount = (Integer)sqlMapper.queryForObject("forum.count", vo);
	...
	public ArrayList list(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("forum.list", vo);
		return list;
	}
	...
	public int insert(HashMap<String, Object> vo) throws SQLException {
		int no = (Integer)sqlMapper.insert("forum.insert",vo);
		return no;
	}
	...
	public int update(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("forum.filenames", vo);
		...
		int r = sqlMapper.update("forum.update", vo);
		return r;
	}
	...
	public HashMap<String, Object> read(HashMap<String, Object> vo, boolean userCon) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("forum.read", vo);
		
		if (userCon) {
			sqlMapper.update("forum.updateReadno", vo);
		}
		return data;
	}
	
	public HashMap<String, Object> readDate(HashMap<String, Object> vo, boolean userCon) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("forum.readDate", vo);
	...
	public int delete(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("forum.read", vo);
		int r = sqlMapper.delete("forum.delete", vo);
		if (r > 0) {
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename")));
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename2")));
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename3")));
	...
	public ArrayList mainList(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("forum.mainList", vo);
		return list;
	}
