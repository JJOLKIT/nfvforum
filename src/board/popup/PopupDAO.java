...
public class PopupDAO {
	...
	private static PopupDAO instance;
	...
	public String getTargetURLParam(String pageUrl, HashMap<String, Object> hm, String index) throws Exception{
		...
		if (hm != null) {
			...
			if(!"".equals(Function.checkNull(Function.parseStr(hm.get("sstartdate"))))){
				strList.append("&sstartdate="+Function.parseStr(hm.get("sstartdate")));
			}
			if(!"".equals(Function.checkNull(Function.parseStr(hm.get("senddate"))))){
				strList.append("&senddate="+Function.parseStr(hm.get("senddate")));
			}
			if (!"0".equals(index)) {
	...
	public int[] count(HashMap<String, Object> vo) throws SQLException {
		int rowCount = (Integer)sqlMapper.queryForObject("popup.count", vo);
	 ...
	 * @throws IOException 
	 */
	public ArrayList list(HashMap<String, Object> vo) throws SQLException, IOException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("popup.list", vo);
	...
	public int insert(HashMap<String, Object> vo) throws SQLException {
		int no = (Integer)sqlMapper.insert("popup.insert",vo);
		return no;
	}
	...
	public int update(HashMap<String, Object> vo) throws SQLException {
		...
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("popup.filenames", vo);
		...
		int r = sqlMapper.update("popup.update", vo);
		return r;
	}
	 ...
	 * @throws IOException 
	 */
	public HashMap<String, Object> read(HashMap<String, Object> vo, boolean userCon) throws SQLException, IOException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("popup.read", vo);

		if (userCon) {
			sqlMapper.update("popup.updateReadno", vo);
		}
	...
	public int delete(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("popup.read", vo);
		int r = sqlMapper.delete("popup.delete", vo);
		if (r > 0) {
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename")));
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename2")));
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename3")));
	...
	public HashMap<String, Object> prev(HashMap<String, Object> vo) throws SQLException{
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("popup.prev", vo);
		
		return data;
	}
	
	public HashMap<String, Object> next(HashMap<String, Object> vo) throws SQLException{
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("popup.next", vo);
	...
	public ArrayList mainList(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("popup.mainList", vo);
		return list;
	}
