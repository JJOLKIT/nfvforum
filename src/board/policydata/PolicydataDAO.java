...
public class PolicydataDAO {
	...
	private static PolicydataDAO instance;
	 ...
	 * @return instance
	 */
	public static PolicydataDAO getInstance() {
		if (instance == null) {
			instance = new PolicydataDAO();
		}
	...
	public int[] count(HashMap<String, Object> vo) throws SQLException {
		int rowCount = (Integer)sqlMapper.queryForObject("policydata.count", vo);
	...
	public ArrayList list(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("policydata.list", vo);
		return list;
	}
	...
	public int insert(HashMap<String, Object> vo) throws SQLException {
		int no = (Integer)sqlMapper.insert("policydata.insert",vo);
		return no;
	}
	...
	public int update(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("policydata.filenames", vo);
		...
		int r = sqlMapper.update("policydata.update", vo);
		return r;
	}
	...
	public HashMap<String, Object> read(HashMap<String, Object> vo, boolean userCon) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("policydata.read", vo);
		
		if (userCon) {
			sqlMapper.update("policydata.updateReadno", vo);
		}
		return data;
	}
	
	public HashMap<String, Object> prev(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("policydata.prev", vo);
		
		return data;
	}
	
	public HashMap<String, Object> next(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("policydata.next", vo);
	...
	public int delete(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("policydata.read", vo);
		int r = sqlMapper.delete("policydata.delete", vo);
		if (r > 0) {
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename")));
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename2")));
			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename3")));
	...
	public ArrayList mainList(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("policydata.mainList", vo);
		return list;
	}
	
	public static void main(String[] args) throws Exception {
		PolicydataDAO dao = PolicydataDAO.getInstance();
