...
public class FaqDAO {
	...
	public int[] count(HashMap<String, Object> vo) throws SQLException {
		int rowCount = (Integer)sqlMapper.queryForObject("faq.count", vo);
	...
	public ArrayList list(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("faq.list", vo);
		return list;
	}
	...
	public int insert(HashMap<String, Object> vo) throws SQLException {
		if (vo.get("rank") == null || "".equals(vo.get("rank")) || "null".equals(vo.get("rank"))) {
			vo.put("rank", 0);
		}
		int no = (Integer)sqlMapper.insert("faq.insert",vo);
		return no;
	}
	...
	public int update(HashMap<String, Object> vo) throws SQLException {
		...
		int r = sqlMapper.update("faq.update", vo);
	...
	public HashMap<String, Object> read(HashMap<String, Object> vo, boolean userCon) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("faq.read", vo);
		
		if (userCon) {
			sqlMapper.update("faq.updateReadno", vo);
		}
		return data;
	}
	...
	public int delete(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("faq.read", vo);
		int r = sqlMapper.delete("faq.delete", vo);
		return r;
	}
