...
public class AfterDAO {
	...
	private static AfterDAO instance;
	 ...
	 * @return instance
	 */
	public static AfterDAO getInstance() {
		if (instance == null) {
			instance = new AfterDAO();
		}
	...
	public int[] count(HashMap<String, Object> vo) throws SQLException {
		int rowCount = (Integer)sqlMapper.queryForObject("after.count", vo);
	...
	public ArrayList list(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("after.list", vo);
		return list;
	}
	...
	public int insert(HashMap<String, Object> vo) throws SQLException {
		int no = (Integer)sqlMapper.insert("after.insert",vo);
		return no;
	}
...
//		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("after.filenames", vo);
...
//		}
		int r = sqlMapper.update("after.update", vo);
		return r;
	}
	...
	public HashMap<String, Object> read(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("after.read", vo);
	...
	public int delete(HashMap<String, Object> vo) throws SQLException {
		HashMap<String, Object> data = (HashMap<String, Object>)sqlMapper.queryForObject("after.read", vo);
		int r = sqlMapper.delete("after.delete", vo);
//		if (r > 0) {
//			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename")));
//			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename2")));
//			Function.fileDelete(Function.parseStr(vo.get("uploadPath")), Function.parseStr(data.get("filename3")));
//		}
	...
	public int passwordCheck(HashMap<String, Object> vo) throws SQLException {
		int cnt = (Integer)sqlMapper.queryForObject("after.passwordCheck", vo);
		return cnt;
	}
	...
	public ArrayList mainList(HashMap<String, Object> vo) throws SQLException {
		ArrayList list = (ArrayList)sqlMapper.queryForList("after.mainList", vo);
		return list;
	}
	
	public static void main(String[] args) throws Exception {
		AfterDAO dao = AfterDAO.getInstance();
