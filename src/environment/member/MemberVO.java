...
public class MemberVO extends Parameter {
	 ...
	 * @throws Exception
	 */
	public static MemberVO getParam(int pageRows, HttpServletRequest request) throws Exception {
		MemberVO param = new MemberVO(pageRows);
		param = (MemberVO)BeanUtils.bind(request, param);
		return param;
	}
	...
	public void setMember_fk(int admin_fk) {
