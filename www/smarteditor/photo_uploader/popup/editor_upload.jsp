...
<%
String savePath = SiteProperty.EDITOR_UPLOAD_PATH;
// 폴더생성
...
if (!moveDir.exists()) {																										//복사될 경로가 없을경우 만든다.
	...
	String cmd2 = "chown vizenos:vizensoft " + request.getRealPath(savePath);
...
MultipartRequest multi = new MultipartRequest(request, request.getRealPath(savePath), SiteProperty.EDITOR_MAXSIZE, "utf-8",  new MyFileRenamePolicy());
