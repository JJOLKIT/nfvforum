...
<section id="sub" class="external">
    ...
    <section class="sub_contents color_blue common_forum">
        <div class="container_wrap">
            <div class="container">
                <h3 class="sub_title"><span>대외협력분과</span></h3>
                <div class="cards">
                    <article class="board_card">
                        ...
                        <div>
                            ...
                            <p class="dot_desc">Open Networking Korea (ONK) 개최</p>
                    ...
                    <article class="board_card">
                        ...
                        <div>
                            <p class="dot_desc">SDN/NFV 관련기관과 포럼간의 대외협력 활동 강화</p>
                            <p class="dot_desc">Open Networking Korea (ONK) 개최</p>
        ...
        <article class="container_wrap">
            <div class="container org_chart_wrap">
                <h4 class="sub_des_title">대외협력분과 조직도</h4>
                <dl class="org_chart horizontal">
                    <dt class="common_rect blue no-line">대외협력분과</dt>
                    <dt class="common_rect pink">국제협력WG</dt>
                </dl>
            </div>
        </article>
        <div class="container_wrap">
