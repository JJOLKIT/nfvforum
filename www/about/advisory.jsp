...
<section id="sub" class="committee">
    ...
    <section class="sub_contents color_blue common_forum">
        <div class="container_wrap">
            <div class="container">
                <h3 class="sub_title"><span>자문위원회</span></h3>
                <div class="cards">
                    <article class="board_card">
                        <h4 class="sub_des_title">자문위원회 소개</h4>
                        <div>
                            <p class="dot_desc">네트워크 분야의 경험과 역량이 많은 전문가로 구성된 자문위원회</p>
                    ...
                    <article class="board_card">
                        ...
                        <div>
                            <p class="dot_desc">포럼 장·단기 발전계획 수립과 시행에 관한 내용 자문</p>
                            <p class="dot_desc">포럼 운영의 중요 의사결정 내용 자문</p>
        ...
        <div class="container_wrap">
            <article class="container board_ranking">
                <h4 class="sub_des_title">자문위원회 구성원</h4>
                <div class="table_wrap">
                    <table class="table_ranking">
                        <caption>자문위원회 구성원 리스트</caption>
                        <thead>
                            <tr>
