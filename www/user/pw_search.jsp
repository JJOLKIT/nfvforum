...
<script>
	function goSave(){
		...
		var emailMerge = $("#email3").val()+'@'+$("#email2").val();
	...
	<section class="sub_contents">
		<div class="container">
			...
			<div class="cont1">
				<div class="inner">
					<div class="top">
						<h4 class="user_title">비밀번호 찾기</h4>
						<span>가입하신 이메일주소를 확인하여 해당 메일로 임시비밀번호를 발급해드립니다.</span>
					</div>
					<form name="board" id="board" method="post" action="process.jsp">
					<input type="hidden" name="email" id="email"/>
					<div class="mid clear">
						<input type="text" class="u_id" placeholder="아이디"/ name="id" id="id">
						<input type="text" class="u_name" placeholder="이름"/ name="name" id="name">
						<div class="email">
					...
					<input type="hidden" name="cmd" value="pwsearch" />
					</form>
				</div>
			</div>
	</section>
