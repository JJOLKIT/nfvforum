			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<input type="radio" name="category" value="1" checked="checked" />공지사항
							<input type="radio" name="category" value="2" />소식전달
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							...
							<font color="blue">이미지사이즈 : 640 * 395px</font>	
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row" style="color:red"><label for="">첨부파일</label></th>
						<td colspan="3">
