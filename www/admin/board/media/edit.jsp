...
<script>
	...
	jQuery(window).load(function(){
		...
		initCal({id:"articledate",type:"day",today:"y"});
	});
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					...
					<tr>
						<th>기사일자</th>
						<td colspan="3">
							<input type="text" name="articledate" id="articledate" value="<%=data.get("articledate") %>" class="dateTime" />
							<span id="CalarticledateIcon" style="height:22px; line-heught:22px; vertical-align:middle">
							<img src="/admin/img/ico_calendar.gif" id="CalarticledateIconImg" style="cursor:pointer" />
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row" ><label for="">관련링크1</label></th>
						<td colspan="3">
							<input type="text" id="link1" name="link1" class="w50" value="<%=data.get("link1")%>"/>
						</td>
					</tr>
					<tr>
						<th scope="row" ><label for="">관련링크2</label></th>
						<td colspan="3">
							<input type="text" id="link2" name="link2" class="w50" value="<%=data.get("link2")%>"/>
						</td>
					</tr>
					<tr>
						<th scope="row" ><label for="">관련링크3</label></th>
						<td colspan="3">
							<input type="text" id="link3" name="link3" class="w50" value="<%=data.get("link3")%>"/>
						</td>
					</tr>
					<tr>
