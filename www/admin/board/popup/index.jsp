			...
			<table class="searchTable">
				...
				<tbody>
					<tr>
						<th class="bno">언어</th>
						<td class="bno">
							<select name="slang" onchange="goSearch();">
								<option value="">선택</option>
								<option value="KR" <%=Function.getSelected("KR", Function.parseStr(param.get("slang"))) %>>국문</option>
								<option value="EN" <%=Function.getSelected("EN", Function.parseStr(param.get("slang"))) %>>영문</option>
								<option value="CN" <%=Function.getSelected("CN", Function.parseStr(param.get("slang"))) %>>중문</option>
								<option value="JP" <%=Function.getSelected("JP", Function.parseStr(param.get("slang"))) %>>일문</option>
							</select>
						</td>
						<th class="bno">검색어</th>
						<td class="bno">
					...
					<tr>
						...
						<td <%=targetUrl %>>
							<%
								...
								if("0".equals(Function.parseStr(data.get("display")))){
									out.print("노출");
								}else{
									out.print("미노출");
								}
