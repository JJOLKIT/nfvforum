			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					<tr>
						...
						<td>
							<!-- <input type="checkbox" name="top" id="top" value="1" /> <label for="top">탑공지 (상단노출)</label> 
							<span class="h_line"></span> -->
							<input type="checkbox" name="display" id="display" value="1" /> <label for="display">메인노출</label>
						</td>
					</tr>
					<!-- 
					<tr>
						<th>일시</th>
						<td><input type="text" name="photo_date"/></td>
						<th>장소</th>
					...
					<tr>
						...
						<td colspan="3">
							...
							<font color="blue">이미지사이즈 : 640 * 640px</font>	
						</td>
					</tr>
					<!-- 
					<tr>
