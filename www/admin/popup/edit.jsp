			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="radio" name="display"  value="1" <%=Function.getChecked("1", Function.parseStr(data.get("display"))) %> id="d1"/> <label for="d1">노출</label> <span class="h_line"></span>
							<input type="radio" name="display"  value="2" id="d2" <%=Function.getChecked("2", Function.parseStr(data.get("display"))) %>/> <label for="d2">미노출</label>
						</td>
					</tr>
					<tr>
						<th>노출기간</th>
					...
					<tr>
						<th>가로위치(px)</th>
						<td>
							<input type="text" name="leftpx" id="leftpx" value="<%=Function.parseInt(data.get("leftpx")) %>" autocomplete="off" onkeyup="onlyNumber(this);" maxlength="3" class="wid100"/>
						</td>
						<th>세로위치(px)</th>
						<td><input type="text" name="toppx" id="toppx" value="<%=Function.parseInt(data.get("toppx")) %>" autocomplete="off" onkeyup="onlyNumber(this);" maxlength="3" class="wid100"/></td>
					</tr>
					<tr>
						<th>작성자</th>
						<td colspan="3">
