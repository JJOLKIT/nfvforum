			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<input type="radio" name="category" value="1" <%=Function.getChecked("1", Function.parseStr(data.get("category")))%>/> 주요고객
							<input type="radio" name="category" value="2" <%=Function.getChecked("2", Function.parseStr(data.get("category")))%>/> 후원기관
							<!--<input type="radio" name="category" value="3" <%=Function.getChecked("3", Function.parseStr(data.get("category")))%>/> 제휴 민간기관-->
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="" name="contents" class="w50" title="내용을 입력해주세요" value="<%=data.get("contents")%>"/>
						</td>
					</tr>
					<tr>
