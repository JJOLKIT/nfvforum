			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<input type="radio" name="category" value="1" checked/> 주요고객
							<input type="radio" name="category" value="2" /> 후원기관
							<!--<input type="radio" name="category" value="3" /> 제휴 민간기관-->
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row" ><label fot="">*내용</label></th>
						<td colspan="3">
							<input type="text" id="" name="contents" class="w50" title="내용을 입력해주세요" />
						</td>
					</th>
					<tr>
