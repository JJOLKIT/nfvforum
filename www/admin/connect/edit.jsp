			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<input type="radio" name="category" value="1" <%=Function.getChecked("1", Function.parseStr(data.get("category")))%>/>공지사항
							<input type="radio" name="category" value="2" <%=Function.getChecked("2", Function.parseStr(data.get("category")))%>/>소식전달
						</td>
					</tr>
					<tr>
