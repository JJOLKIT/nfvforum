...
<%
	...
	if(!"".equals(Function.parseStr(param.get("scategory")))){
		scategory = Function.parseInt(param.get("scategory"));
	}else{
...
<section id="sub" class="tech">
	...
	<section class="sub_contents">
		<div class="container_wrap">
			<div class="container">
				<h3 class="sub_title"><span><%=pageTitle %></span></h3>
				 <%@ include file ="/reference/tech/tech_menu.jsp" %>
				<div class="list">
					<!-- 여기서부터 삽입--->
			        <div class="bbs">
			            <table class="list">
			                ...
			                <tbody>
			                    ...
			                    <tr <%if(Function.parseInt(data.get("top")) == 1){ %>class="notice"<%} %> >
			                        ...
			                        <td class="file on"><a href="/include/download.jsp?path=<%=Function.parseStr(uploadPath)%>&vf=<%=data.get("filename")%>&af=<%=Function.parseStr(data.get("filename_org"))%>" target="_blank"><%=Function.parseStr(data.get("filename_org"))%></a></td>
