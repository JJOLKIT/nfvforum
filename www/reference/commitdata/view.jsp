...
<%
	...
	if(!loginCheck || "1".equals(Function.parseStr(memberInfo.get("grade"))) || "2".equals(Function.parseStr(memberInfo.get("grade"))) || "3".equals(Function.parseStr(memberInfo.get("grade")))) { //비로그인 이거나 운영위원이 아니라면 
%>

<script>
	alert('운영위원만 이용 가능합니다. 로그인 후 다시 접속하세요.');
	history.back();
</script>
...
<section id="sub">
	...
	<section class="sub_contents">
		<div class="container_wrap">
			<div class="container">
				<h3 class="sub_title"><span>운영위원회 자료실</span></h3>
				<article class="sub_cont">
					<h4 class="sub_des_title"></h4>
					<!-- <h4 class="sub_des_title">운영위원회 자료실 입니다.</h4> -->
					<div id="warp">
						<div class="contents">
							<!-- 여기서부터 삽입--->
		        <div class="bbs">
